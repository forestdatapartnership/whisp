...
def whisp_risk(
    ...
    ind_5_name="Indicator_5_timber_2020_status",
    low_name="no",
    high_name="yes"
):
    """
    ...
    if ind_5_input_columns is None:
        ind_5_input_columns = get_cols_ind_5_degrad(lookup_gee_datasets_df)
...
def get_cols_ind_5_primary(lookup_gee_datasets_df):
    """
    ...
    return list(lookup_gee_datasets_df["dataset_name"][
        (lookup_gee_datasets_df["use_for_risk"] == 1) &
        (lookup_gee_datasets_df["theme"] == "primary")
    ])

def get_cols_ind_6_nat_reg(lookup_gee_datasets_df):
    """
    ...
    return list(lookup_gee_datasets_df["dataset_name"][
        (lookup_gee_datasets_df["use_for_risk"] == 1) &
        (lookup_gee_datasets_df["theme"] == "naturally_reg_2020")
    ])

def get_cols_ind_7_primary(lookup_gee_datasets_df):
    """
    Generate a list of dataset names for primary forest in 2020
