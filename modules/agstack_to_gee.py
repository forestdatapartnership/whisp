...
#     if check_geometry_type(geo_json)=='Polygon':        
#         poly_feature = ee.Feature(ee.Geometry.Polygon(geo_json),ee.Dictionary([geo_id_column,geo_id]))
        
#     elif check_geometry_type(geo_json)=='Point':
#         point_feature = ee.Feature(ee.Geometry.Point(geo_json),ee.Dictionary([geo_id_column,geo_id]))
        
#         poly_feature = buffer_point_to_required_area(point_feature,required_area,"ha")
...
def check_geometry_type(geojson_obj):
