...
https://doi.org/10.1038/s41893-021-00729-z</td></tr>
  ...
  <tr><td colspan="3"><b>Datasets of disturbances after 2020-12-31:</b></td></tr>
    ...
    <tr><td colspan="3"><b>Plot location:</b></td></tr>
      <tr><td rowspan="3">Country</td><td rowspan="3"> ISO3 code for the country, based on majority coverage of plot. Image asset created from 'gaul1_code' and converted to 'iso3_code' using a lookup table. Boundaries may contain errors and do not imply official endorsement or acceptance. Boundaries may contain errors and do not imply official endorsement or acceptance.</td><td rowspan="2">Franceschini, G., Khan, A., Moretti, L., Nyabuti, K., Asif, M., Bezuidenhoudt, E. and Morteo, K. 2025. The Global Administrative Unit Layers (GAUL) 2024. Technical guidelines. Rome, FAO. https://doi.org/10.4060/cd4262en </td></tr>
    <tr><td rowspan="3">ProducerCountry</td><td rowspan="3"> ISO2 code for the country, based on majority coverage of plot. Image asset created from 'gaul1_code'. Codes converted to  ISO2 using a lookup table and tne country-converter Python package. Boundaries may contain errors and do not imply official endorsement or acceptance. Boundaries may contain errors and do not imply official endorsement or acceptance.</td><td rowspan="2">Franceschini, G., Khan, A., Moretti, L., Nyabuti, K., Asif, M., Bezuidenhoudt, E. and Morteo, K. 2025. The Global Administrative Unit Layers (GAUL) 2024. Technical guidelines. Rome, FAO. https://doi.org/10.4060/cd4262en </td></tr>
    <tr></tr>
    <tr><td>ee.Image("projects/ee-whisp/assets/admin_bounds/gaul_2024_level_1_code_500m")</td></tr>
    <tr><td rowspan="3">Admin_Level_1</td><td rowspan="3"> Name of subnational administrative boundary (Level 1), based on majority coverage of plot. Image asset created from 'gaul1_code' and converted to 'gaul1_name' using a lookup table. Boundaries may contain errors and do not imply official endorsement or acceptance.</td><td rowspan="2">Franceschini, G., Khan, A., Moretti, L., Nyabuti, K., Asif, M., Bezuidenhoudt, E. and Morteo, K. 2025. The Global Administrative Unit Layers (GAUL) 2024. Technical guidelines. Rome, FAO. https://doi.org/10.4060/cd4262en </td></tr>
    <tr></tr>
    <tr><td>ee.Image("projects/ee-whisp/assets/admin_bounds/gaul_2024_level_1_code_500m")</td></tr>
