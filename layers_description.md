...
- the yes & no answers to the four risk categories in the [decision tree](https://github.com/user-attachments/assets/007b5f50-3939-4707-95fa-98be4d56745f) and the final risk category ("low", "high", or "more info needed");
- some additional metadata and geographic information, e.g. ID, geometry type, hectares, country, etc...

*(Disclaimer: The number of layers is subject to changes. The number of 150 layers mentioned (124+26) might deviate slightly, but not fundamentally.)*
