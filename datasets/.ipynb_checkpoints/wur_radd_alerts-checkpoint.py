...
latest_radd_alert_confirmed_recent_area_hectares = area_stats.set_scale_property_from_image(latest_radd_alert_confirmed_recent_area_hectares,radd.first(),debug=True).set("dataset_id",dataset_id)
