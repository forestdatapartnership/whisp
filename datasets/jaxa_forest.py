...
JAXA_forestNonForest_2020_area_hectares = area_stats.set_scale_property_from_image(JAXA_forestNonForest_2020_area_hectares,JAXA_forestNonForest_raw.first(),0,debug=True).set("dataset_id",dataset_id)