...
primary_HT_forests_2020_area_hectares = area_stats.set_scale_property_from_image(primary_HT_forests_2020_area_hectares,primary_HT_forests_2001_raw.first(),0,debug=True)
